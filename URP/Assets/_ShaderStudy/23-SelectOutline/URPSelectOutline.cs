...
[ExecuteInEditMode]
public class URPSelectOutline : ScriptableRendererFeature
{
    public enum TYPE
    {
    ...
    class DrawSoildColorPass : ScriptableRenderPass
    {
        ...
        URPSelectOutline selectOutline = null;
        ShaderTagId shaderTagId = new ShaderTagId("DepthOnly");//只有在这个标签LightMode对应的Shader才会被绘制
        FilteringSettings filter;
        public DrawSoildColorPass(MySetting setting,URPSelectOutline selectOutline)
        {
    ...
    class Calculate : ScriptableRenderPass
    {
        ...
        public Calculate(MySetting setting,URPSelectOutline render,RenderTargetIdentifier source)
        {
            this.setting = setting;
