Shader "URP/URPDecal"
{
    Properties
    {
        ...
        _EdgeStrechPrevent("EdgeStrechPrevent",Range(-1,1)) = 0
    }
    SubShader
    {
        Tags 
        ...
        {        
            ...
            {   
                ...
                float3 decalPos = i.cameraPosOS + i.cam2vertexRayOS.xyz*SSdepth;//模型空间下的计算：相机空间+相机朝着顶点的射线（已透除）*相机空间的线性深度
                ...
                mask *= decalNormal.y>0.2*_EdgeStrechPrevent?1:0;//边缘拉伸的防止阈值
